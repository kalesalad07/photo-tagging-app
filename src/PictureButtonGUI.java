...
public class PictureButtonGUI extends JFrame {
    ...
    public PictureButtonGUI(String[] pictureNames) {
        setTitle("Pictures");
...
//                    };
                	...
                	try {
            			...
            			String query = "select DRIVE_LINK from photos where club_dept = (select id from club_dept where name = '"+ name + "');";
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                ...
                new PictureButtonGUI(pictureNames);
            }
        });
    }
}
